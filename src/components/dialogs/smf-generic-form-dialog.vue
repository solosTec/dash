...
} from "@/shared/smf-dialog.service";
...
export default Vue.extend({
  ...
  mounted() {
    ...
    const originalFormModel = JSON.stringify(
      this.dialogContentComponent.formModel
    );

    this.dialogContentComponent.$on(
      "formState",
      ({ invalid, formModel }: DialogFormState<any>) => {
