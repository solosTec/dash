<template lang="html">
  <b-form @submit.prevent="">
    <b-row>
      <b-col class="shadow" md="10">
        <b-row>
          <b-col md="6">
            <b-form-group
              :label="$t('config-gateway-05')"
              label-for="smf-form-gw-server-x"
            >
              <b-form-input
                id="smf-form-gw-server-x"
          ...
          <b-col md="6">
            <b-form-group
              ...
              label-for="smf-form-gw-manufacturer-x"
            >
              <b-form-input
                id="smf-form-gw-manufacturer-x"
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group
              ...
              label-for="smf-form-gw-pwd-x"
            >
              <b-input-group>
                <b-form-input
                  id="smf-form-gw-pwd-x"
                ...
                <b-input-group-append>
                  <b-button variant="info" v-on:click.stop="generatePassword"
                    >&#x21ba;</b-button
                  >
                </b-input-group-append>
              </b-input-group>
        ...
        <b-row class="p-3">
          <b-col md="12">
            <b-button
              type="submit"
              variant="primary"
              v-on:click.stop="onGatewayUpdate"
        ...
        <b-row class="p-3">
          <b-col md="12">
            <b-button
              ...
              type="submit"
              variant="warning"
              v-on:click.stop="onGatewayReboot"
            >
              {{ btnRebootTitle }}
            </b-button>
          </b-col>
        ...
        <b-row class="p-3">
          <b-col md="12">
            <b-button
              type="submit"
              variant="danger"
              v-on:click.stop="onGatewayDelete"
              >{{ btnDeleteTitle }}
            </b-button>
          </b-col>
        </b-row>
  ...
  methods: {
    ...
    handleDeleteGatewayOk(event: Event) {
      ...
      this.gateways.forEach((gateway: any) => {
        this.wsDelegate.ws_submit_key("delete", "config.gateway", {
          tag: [gateway.pk]
        });
      });
      this.$nextTick(() => {
    ...
    handleRebootGatewayOk(event: Event) {
      event.preventDefault();
      this.gateways.forEach((gateway: any) => {
        this.wsDelegate.ws_submit_request(
          MESSAGE_REQUEST.setProcParameter,
          SML_CODES.CODE_REBOOT,
          [gateway.pk]
        );
      });
      this.$nextTick(() => {
