    ...
    <b-container fluid>
      ...
      <b-row>
        <b-col md="2" offset-md="10">
          <b-pagination v-model="currentPage" :total-rows="targets.length" :per-page="perPage"/>
        </b-col>
      </b-row>
...
export default  {
    ...
    mounted() {
        this.ws_open("/smf/api/target/v0.7");
    },
        ...
        ws_on_data(obj) {
            if (obj.cmd != null) {
                ...
                if (obj.cmd == 'insert') {
                    ...
                    var idx = this.targets.findIndex(rec => obj.key.length == 1 && obj.key[0] == rec.channel);
