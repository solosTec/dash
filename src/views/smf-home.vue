        ...
        <b-container fluid>
            <b-card-group deck>
                ...
                <b-card :title="$t('config-home-01')" class="shadow">
                    ...
                    <b-button to="/config/device" href="#" variant="primary">{{$t('nav-devices')}}</b-button>
                    <div slot="footer"><small class="text-muted">{{$t('lead-device', {count: deviceCount})}}</small></div>
                </b-card>
                ...
                <b-card :title="$t('config-home-03')" class="shadow">
                    ...
                    <b-button to="/config/meter" href="#" variant="primary">{{$t('nav-meter')}}</b-button>
                    <div slot="footer"><small class="text-muted">{{$t('lead-meter', {count: meterCount})}}</small></div>
                </b-card>
            ...
            <b-card-group deck>
                ...
                <b-card :title="$t('config-home-04')" class="shadow">
                    ...
                    <b-button to="/status/sessions" href="status.session.html" variant="primary">{{$t('nav-sessions')}}</b-button>
                    <div slot="footer"><small class="text-muted">{{$t('lead-status-session', {count: sessionCount})}}</small></div>
                </b-card>
                ...
                <b-card :title="$t('config-home-06')" class="shadow">
                    ...
                    <b-button to="/status/connections" href="status.connections.html" variant="primary">{{$t('nav-connections')}}</b-button>
                    <div slot="footer"><small class="text-muted">{{$t('lead-status-connections', {count: connectionCount})}}</small></div>
                </b-card>
