        ...
        options: {
          channels: [
            //Sprachumschaltung funktioniert nicht
              { text: this.$t('config-gateway-22'), value: 'status-word' },
              { text: this.$t('config-gateway-23'), value: 'ipt' },
              { text: this.$t('config-gateway-24'), value: 'firmware' },
              { text: this.$t('config-gateway-25'), value: 'memory-usage' },
              { text: this.$t('config-gateway-26'), value: 'devices' },
              { text: this.$t('config-gateway-27'), value: 'w-MBus' },
              { text: this.$t('config-gateway-28'), value: 'iec' }
              ],
          selected: [],
          allSelected: false,
          indeterminate: false
