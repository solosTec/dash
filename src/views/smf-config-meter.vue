                  ...
                  <b-col md="6">
                    <b-form-group label="Query last record">
                      <b-button
                        type="submit"
                        variant="success"
                        v-on:click.stop="onMeterQuery"
                        >{{ btnQueryTitle }}</b-button
                      >
                    </b-form-group>
                  </b-col>
                </b-row>
                  ...
                  <b-col md="6">
                    <b-form-group label="Refresh data">
                      <b-button
                        ...
                        variant="success"
                        :disabled="!isOnline"
                        v-on:click.stop="onPushTargetQuery"
                        >Query</b-button
                      >
                    </b-form-group>
                  </b-col>
                  ...
                  <b-col md="6">
                    <b-form-group label="Refresh data">
                      <b-button
                        ...
                        variant="success"
                        :disabled="!isOnline"
                        v-on:click.stop="onDataMirrorQuery"
                        >Query</b-button
                      >
                    </b-form-group>
                  </b-col>
