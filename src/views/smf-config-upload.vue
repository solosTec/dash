    ...
    <b-container fluid>
      <b-form-row>
        <b-col class="m-2 p-2 shadow">
          ...
          >
            ...
            <b-form-radio-group
              ...
              class="mt-3"
            >
              <b-form-radio value="append">
                Append
              </b-form-radio>
              <b-form-radio value="merge">
                Merge
              </b-form-radio>
              <b-form-radio value="subst">
                Overwrite
              </b-form-radio>
            </b-form-radio-group>
            <b-form-radio-group
              ...
              class="mt-3"
            >
              <b-form-radio value="v3.2">
                Version 3.2
              </b-form-radio>
              <b-form-radio value="v4.0">
                Version 4.0
              </b-form-radio>
              <b-form-radio value="v0.8">
                Version 0.8
              </b-form-radio>
            </b-form-radio-group>
            <b-button
        ...
        <b-col class="m-2 p-2 shadow">
          ...
          <p>{{ gateway_text }}</p>
          <b-form
            @submit="onSubmitGateway"
            @reset="onResetGateway"
          >
            <b-form-file
              v-model="gw.file"
            ...
            <p class="mt-3">
              <small class="text-muted">{{ gatewayCount }} gateway(s) configured</small>
            </p>
          </b-form>
        </b-col>
      ...
      <b-form-row>
        <b-col class="m-2 p-2 shadow">
          ...
          >
            ...
            <p class="mt-3">
              <small class="text-muted">{{ LoRaCount }} LoRa devices(s) configured</small>
            </p>
          </b-form>
        </b-col>
